...
from task.views import TaskByProfileViewSet, TodoItemByProfileViewSet, ActivitiesByProfileViewSet
...
apipatterns = [
    ...
    path('activities/', ActivitiesByProfileViewSet.as_view({ 'get': 'list' })),
